...
const LPaneCategs = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-primary bg-secondary/40 mb-4 px-4 py-2 rounded-xl shadow-lg text-center">
        Categories
      </h2>

      <section className="flex flex-col gap-2 bg-secondary/20 rounded-lg py-2 shadow-lg">
